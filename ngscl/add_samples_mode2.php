  ...
  if ($_POST['process_fields'] == 1)
  {
    if (isset($_POST['submit_table']))
    {
      $sample_line_array = array_of_sample_data (
       'custom', $use_sample_bonus_columns, '');
...
function addRow(sampleMouseover, use_sample_bonus_columns)
{
  ...
  oElement_3 = inputTextElement("12", "inputrow", "barcode[]",
               "Only alphanumeric characters and underscore allowed.");
  oCell_3.appendChild(oElement_3);
  // barcode index column
  var oCell_4 = newRow.insertCell(-1);
  oElement_4 = inputTextElement ("35", "inputrow", "barcode_index[]",
   "Only the characters A, C, G, and T are permitted.");
  oElement_4.setAttribute("onblur", "testDNAntField(this);");
  ...
  oElement_9 = copyRowButtonElementParm("buttonrow", "Copy", "Copy row and append to end of table.", sampleMouseover, use_sample_bonus_columns);
...
function copyRow(input_index, sampleMouseover, use_sample_bonus_columns)
{
  var selectCount = 0;
  var inputCount = 0;
  var textAreaCount = 0;
...
;
  ...
  inputCount++;
  var oCell_3 = newRow.insertCell(-1);
  oElement_3 = inputTextElement ("8", "inputrow", "barcode[]",
               "Only alphanumeric characters and underscore allowed.",
               input_text);
  oCell_3.appendChild(oElement_3);
  // barcode index column
