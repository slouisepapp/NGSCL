...
<?php
  echo '<title>Contact Information, ',$abbreviated_app_name,'</title>';
?>
...
<?php
  echo '<h1 style="text-align: center"><span class="titletext">',
       'Contact Information - ',$app_name,'</span></h1>';
  echo '<!-- end #header --></div>';
  echo '<div id="mainContent">';
  if (isset ($_GET['contact_uid']) &&
      trimmed_string_not_empty ($_GET['contact_uid']))
  {
    $_SESSION['contact_uid'] = $_GET['contact_uid'];
