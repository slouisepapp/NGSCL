...
if (isset($_POST['process']))
{
  if ($_POST['process'] == 1)
  {
    if (isset($_POST['submit_return_to_details']))
    {
      ...
      exit;
    } elseif (isset($_POST['submit_show_all_projects'])) {
      ...
      header("location: update_lane_comments_active_single.php?project_uid=".
...
<?php
  ...
  echo '<table name ="sample_table" id="sample_table" ',
  ...
  if (!$result_run_lane)
  {
    ...
    // Get all the samples for this lane.
    ...
    if (!$result_lane)
    {
      ...
      for ($i=0;$i<pg_num_rows($result_lane);$i++)
      {
        ...
        echo '<td style="text-align:left" ',
             ...
             'padding: 5px; text-align:left;"><font face="sylfaen">',
  ...
  echo '<input type="submit" name="submit_show_all_projects" ',
       'value="Show All Projects" class="buttontext" ',
       'title="Show the active samples for all projects." />';
  ...
  if (!$result_td)
  {
    echo '<tr><td class="errortext">',pg_last_error ($dbconn),'</td></tr>';
  } else {
