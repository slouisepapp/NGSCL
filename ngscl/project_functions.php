<?php
$project_log_hints = array (
 'name_of_experimenter' => 'Name of experimenter.',
 'experiment_title' => 'As informative as possible.',
 'run_number' => 'Must be a positive integer.',
 'lanes' => 'Lanes.',
 'experiment_type' => 'RNAseq, miRNAseq, ChIPseq, etc.',
 'results_summary' => 'Notes about quality of the run, cluster problems,'.
                      'adapter dimer problems. Basically, did it work?',
 'account_number' =>  'Account or grant number.',
 'estimated_price' => 'Must be a non-negative number.',
 'estimated_price_comments' => 'Estimated price comments.',
 'cells_used' => 'e.g. tissue, normal donors, clinical samples, '.
                 'purified cells or cellsubsets, activated vs. resting.',
 'experimental_methods' => 'e.g. activation with anti-CD3/CD28 beads.',
 'time_course' => 'e.g. day 0 or 48 hours after activation.',
 'experimental_category' => 'e.g. epigenetics of CD4 memory T cell '.
                            'activation or experiment #ABC345 or ultra deep '.
                            'sequencing for alternative splicing '.
                            'pipeline development.',
 'conditions_comments' => 'Any additional comments on experimental methods.',
 'batching_instructions' => 'Consider the overall design of your experiment '.
                            'such as number of controls vs experimental '.
                            'conditions. Do you need to consider possible '.
                            'batch effects? If yes, how will these samples '.
                            'be processed to minimize the effect of '.
                            'batching on the results?',
 'sample_purification_method' => 'e.g. Trizol, columns.',
 'kits_used' => 'Kits used.',
 'amplification_method' => 'Amplification method.',
 'barcoding_used' => 'Barcoding used.',
 'new_method_or_comparison_study' => 'If this is a new method or comparison '.
                                  'study are there other experiments that are '.
                                  'linked to this one?',
 'library_prep_comments' => 'Any additional comments on library prep.',
 'read_length' => 'e.g. 1x40 or 2x100bp.',
 'adapter_sequences' => 'Only if nonstandard and explain.',
 'barcode_sequences' => 'If applicable.',
 'core_director_approval' => 'CORE director approval.',
 'core_director_approval_date' => 'Date of CORE director approval.',
 'primary_investigator_approval' => 'Primary investigator approval.',
 'primary_investigator_approval_date' => 'Date of primary investigator '.
                                         'approval.'
);
$experimental_conditions_hint = 'Describe the experiment in sufficient detail '.
 'that anyone can understand why you did the experiment, even new members '.
 'of the group or outside collaborators years later that are using our '.
 'datasets for other analyses. Be as specific as possible about the question(s) '.
 'being asked and/or the hypotheses tested. Detail the cells used (e.g. tissue '.
 'normal donors, clinical samples, purified cells or cell subsets, activated '.
 'vs resting), the experimental methods (e.g. activation with anti-CD3/CD28 '.
 'beads), describe any important time points (e.g. 0 or 48 hours after '.
 'activation) and link the experiment, if possible, to a line of experiments '.
 'so that the flow can be followed (e.g. epigenetics of CD4 memory T cell '.
 'activation or experiment #ABC345 or ultra deep sequencing for alternative '.
 'splicing pipeline development).';
// **************************************************************
// This function returns a list of each run in which the input
// sample occurs.
// **************************************************************
function run_list_for_sample ($dbconn, $sample_uid)
{
  require 'user_view.php';
  $run_list = "";
  // Get every run for the input sample.
  ...
  return $run_list;
}  // function run_list_for_sample
// **************************************************************
// This function returns a list of each run in which at least
// one sample occurs for the input project.
// **************************************************************
function run_list_for_project ($dbconn, $project_uid)
{
  require 'user_view.php';
  $run_list = "";
